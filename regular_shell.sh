...
alias dce='clear && docker-compose exec '
alias de='clear && docker exec -it '
alias dcu='clear && docker-compose up '
alias dcub='clear && docker-compose up --build '
alias dcb='clear && docker-compose build '
alias dck='clear && docker-compose kill '
alias dcd='clear && docker-compose down '
alias dcdv='clear && docker-compose down -v'
alias dcrs='clear && docker-compose restart '
