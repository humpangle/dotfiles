...
alias win-vim="MYVIMRC_DIR=$HOME/.config/nvim-win/ XDG_DATA_HOME=~/.local/share/nvim-win NVIM_RPLUGIN_MANIFEST=~/.local/share/nvim-win/rplugin.vim MYVIMRC=$HOME/.config/nvim-win/init.vim nvim -u $HOME/.config/nvim-win/init.vim nvim"
