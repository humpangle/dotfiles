...
M.config = {
  ...
  enable_git_status = false, -- true,
  enable_diagnostics = false, -- true,
  ...
  git_status_async = false, -- true,
  -- These options are for people with VERY largegit repos
  ...
  filesystem = {
    ...
    bind_to_cwd = false, -- true, -- true creates a 2-way binding between vim's cwd and neo-tree's root
    cwd_target = {
    ...
    filtered_items = {
      ...
      show_hidden_count = false, -- true, -- when true, the number of hidden items in each folder will be shown as the last entry
      hide_dotfiles = false, -- true,
      hide_gitignored = false, -- true,
      hide_hidden = false, -- true, -- only works on Windows for hidden files/directories
      hide_by_name = {
        ".DS_Store",
        "thumbs.db",
        "__pycache__",
